...
class Error extends AbstractModel
{
     ...
     * which can have one of three values: Application: Indicates an exception or error
     ...
     * a dependency. Business: Used when your service or a dependent service refused to
     * continue processing on the resource because of a business rule violation such as
