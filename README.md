# (Unofficial) eBay API client (PHP) - Sell / Metadata
...
Starting from version v1.4.1, this project will match according eBay API's versioning. Should you found a matching 
